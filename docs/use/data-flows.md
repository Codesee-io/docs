...
- ![Backend tag](https://codesee-docs.s3.amazonaws.com/back+end+tag.png) - **Backend**: This function connects to a function on the backend.
- ![Navigate to where a function is executed](https://codesee-docs.s3.amazonaws.com/go+to+execution+tag.png) - **Go to execution**: Allows you to go to where the function is executed.
- ![Network request](https://codesee-docs.s3.amazonaws.com/network.png) - **Network request**: Indicates a network request.
- ![State change](https://codesee-docs.s3.amazonaws.com/state_change2.png) - **State change**: Indicates a React state change. 


## Code that ran

CodeSee displays the function name at the top left and the file path to the right of the function name.
...
The column on the right shows all of the values of the variables, functions, objects and so on when you made a recording.

<iframe src="https://codesee-docs.s3.amazonaws.com/03-+Data.mp4" style="width:100%; height:340px;" allow="autoplay;"></iframe>

## Expanders

Most dev tools are organized in files and folders. Normally, to understand what's going on we have to mentally map how functions call each other. With CodeSee, when a function calls another function we don't need to do this mental gymnastics: to see a function that calls another function, you can explore that function by clicking on the expand button to see more about the called function. 
